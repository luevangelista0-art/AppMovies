...
class DetalhesRepositorio {
    ...
    private val listDetalhes: List<Detalhes> = listOf(
        ...
        Detalhes(
            ...
            sessoes = listOf(
                Sessao(101, "12:00", "LEG", "Shopping A" , "Sala 3"),
                Sessao(103, "20:45", "DUB", "Shopping B", "Sala 5")
            )
        ),
        Detalhes(
            2,
            ...
            sessoes = listOf(
                Sessao(201, "14:00", "DUB", "Shopping B", "Sala 7"),
                Sessao(202, "18:30", "DUB", "Shopping C", "Sala 2")
            )
        ),
        Detalhes(
            3,
            ...
            sessoes = listOf(
                Sessao(301, "10:30", "LEG", "Shopping D", "Sala 1"),
                Sessao(304, "22:00", "DUB", "Shopping B", "Sala 8"),
        ...
        Detalhes(
            ...
            sessoes = listOf(
                Sessao(401, "21:00", "DUB", "Shopping C", "Sala 6")
            )
        ...
        Detalhes(
            ...
            sessoes = listOf(
                Sessao(501, "13:40", "DUB", "Shopping A", "Sala 6"),
                Sessao(502, "17:10", "LEG", "Shopping D", "Sala 4"),
        ...
        Detalhes(
            ...
            sessoes = listOf(
                Sessao(601, "11:00", "DUB", "Shopping B", "Sala 3"),
                Sessao(602, "18:45", "DUB", "Shopping C", "Sala 5")
            )
        ),
        Detalhes(
            7,
            ...
            sessoes = listOf(
                Sessao(701, "15:10", "LEG", "Shopping A", "Sala 8"),
                Sessao(703, "21:30", "DUB", "Shopping D", "Sala 1")
            )
        ),
        Detalhes(
            8,
            ...
            sessoes = listOf(
                Sessao(801, "14:20", "DUB", "Shopping B", "Sala 5"),
                Sessao(802, "20:10", "LEG", "Shopping C", "Sala 8")
            )
        )
    )
